...
contract PreTaoToken is Divine {
...
<<<<<<< HEAD:contracts/vested/PreTaoToken.sol
    uint256 initialSupply_ = 304300000 * 1e18;
=======
    uint256 initialSupply_ = 1000000000 * 1e18;
>>>>>>> 02655c7a60d62b5ddbe391674be38d87627393e1:contracts/vested/PreOlympusToken.sol
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal override {
    require( (_balances[to_] > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer pTAO." );
  }

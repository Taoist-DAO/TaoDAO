...
describe("LockStaking", function() {
    ...
    let LockStaking, lockStaking, sLockTao,SLockTao;
    // Uniswap
    ...
    beforeEach(async function () {
        ...
        SLockTao = await ethers.getContractFactory("sLockTaoToken");
        ...
        await lockStaking.initialize(sTaoToken.address,sLockTao.address,200)
    ...
    describe("Deployment", function () {
        ...
        it("Should lock staking", async function () {
        	await lockStaking.lockStake();
        });
